  ...
  it("extracts usage for all configured provider mappings", () => {
    const cases: Array<{
      ...
      },
      {
        ...
        expected: { inputTokens: 20, outputTokens: 8, totalTokens: 28 },
      },
      {
        provider: "openai_chat_completions",
        response: { usage: { prompt_tokens: 11, completion_tokens: 9, total_tokens: 20 } },
        expected: { inputTokens: 11, outputTokens: 9, totalTokens: 20 },
      },
      {
      ...
      },
      {
        ...
        expected: { inputTokens: 12, outputTokens: 6, totalTokens: 18 },
      },
      {
        provider: "anthropic",
        response: { usage: { input_tokens: 30, output_tokens: 9 } },
        expected: { inputTokens: 30, outputTokens: 9, totalTokens: 39 },
      },
      {
        provider: "google",
        response: {
